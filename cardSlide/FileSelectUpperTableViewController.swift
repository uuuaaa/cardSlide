//
//  FileSelectUpperTableViewController.swift
//  cardSlide
//
...
class FileSelectUpperTableViewController: UITableViewController {
    var fileList :[String] = []
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        defaults.setObject(fileList[indexPath.row], forKey: "UpperFile")
